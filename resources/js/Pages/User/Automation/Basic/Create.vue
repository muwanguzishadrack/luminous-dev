    ...
    <AppLayout>
        <div class="bg-white md:bg-inherit pt-10 px-4 md:pt-8 md:p-8 rounded-[5px] text-[#000] h-full md:overflow-y-auto">
            <div class="flex justify-between">
                ...
                <div>
                    <Link href="/automation/basic" class="flex items-center space-x-4 rounded-md bg-slate-200 px-3 py-2 text-sm text-gray-700 hover:bg-slate-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary">
                ...
                <div v-if="form.response_type === 'text'" class="flex py-5">
                    ...
                    <div class="w-[60%] flex space-x-6">
                        <div class="w-[80%]">
                            ...
                            <button type="submit" class="float-right flex items-center space-x-4 rounded-md bg-primary px-3 py-2 text-sm text-white hover:bg-secondary focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-secondary">
                                {{ $t('Save') }}
                            </button>
                        </div>
                    </div>
                ...
                <div v-else-if="form.response_type === 'image' || form.response_type === 'audio'" class="flex py-5">
                    ...
                    <div class="w-[60%] flex space-x-6">
                        <div class="w-[80%]">
                            ...
                            <div v-if="form.errors.response" class="form-error text-[#b91c1c] text-xs">{{ form.errors.response }}</div>
                            <button type="submit" class="mt-10 float-right flex items-center space-x-4 rounded-md bg-black px-3 py-2 text-sm text-white hover:bg-slate-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                                {{ $t('Save') }}
                            </button>
                        </div>
                    </div>
