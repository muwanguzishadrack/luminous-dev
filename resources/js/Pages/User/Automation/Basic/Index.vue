                    ...
                    <div class="bg-white border border-slate-200 rounded-lg py-2 text-sm pb-4 px-4 mb-20">
                        <div class="w-full py-2 mb-2 mt-2">
                            <div class="flex w-full mb-4">
                                ...
                                <div class="ml-auto">
                                    <Link href="/automation/basic/create" class="float-right rounded-md bg-primary px-3 py-2 text-sm text-white shadow-sm hover:bg-secondary focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary">{{ $t('Create') }}</Link>
                                </div>
                            </div>
                            <div class="w-5/5">
                                <!-- Table Component-->
