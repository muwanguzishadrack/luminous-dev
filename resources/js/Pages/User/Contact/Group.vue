                ...
                <div v-else class="md:block pt-20 hidden">
                    <div class="border py-10 w-[30em] rounded-xl bg-white">
                        ...
                        <div class="flex justify-center space-x-4 mt-6">
                            <button @click="openModal()" class="bg-primary hover:bg-secondary rounded-lg text-sm text-white p-2 px-8 text-center capitalize">{{ $t('Add group') }}</button>
                            <button @click="isOpenModal = true" class="bg-primary hover:bg-secondary rounded-lg text-sm text-white p-2 px-8 text-center">{{ $t('Bulk upload') }}</button>
                        </div>
                    </div>
                </div>
            </div>
