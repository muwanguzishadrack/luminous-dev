        ...
        <div class="px-4 md:px-0 flex flex-col bg-white border-l py-4 text-[#000] md:overflow-y-hidden capitalize">
            <div class="flex justify-between md:px-8 border-b pb-4">
                ...
                <div class="space-x-2 flex items-center">
                    <Link href="/templates" class="rounded-md bg-slate-200 px-3 py-2 text-sm text-gray-700 shadow-sm hover:bg-slate-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary">{{ $t('Back') }}</Link>
                    <button @click="submitForm()" type="button" class="capitalize rounded-md px-3 py-2 float-right text-sm text-slate-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary" :class="isFormValid === true ? 'bg-primary hover:bg-secondary shadow-sm' : 'bg-gray-200'" :disabled="!isFormValid || isLoading">
