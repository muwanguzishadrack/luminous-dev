        ...
        <div class="px-4 md:px-0 flex flex-col bg-white border-l py-4 text-[#000]">
            <div class="flex justify-between md:px-8 border-b py-4 pb-2">
                ...
                <div class="space-x-2 flex items-center">
                    ...
                    <button @click="submitForm()" type="button" class="rounded-md px-3 py-2 float-right text-sm text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary capitalize" :class="isFormValid === true ? 'bg-primary hover:bg-secondary shadow-sm' : 'bg-gray-200'" :disabled="!isFormValid || isLoading">
