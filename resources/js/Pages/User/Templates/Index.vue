        ...
        <div class="bg-white md:bg-inherit pt-0 px-4 md:pt-8 md:p-8 rounded-[5px] text-[#000] overflow-y-scroll capitalize">
            <div class="flex justify-between mt-8 md:mt-0">
                ...
                <div class="space-x-2 flex items-center">
                    <button @click="syncTemplates" class="rounded-md px-3 py-2 text-sm text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary capitalize" :class="!isSyncActive ? 'bg-primary hover:bg-secondary shadow-sm' : 'bg-gray-200'" :disabled="isSyncActive">
                    ...
                    <Link href="/templates/create" class="md:block hidden rounded-md bg-primary px-3 py-2 text-sm text-white shadow-sm hover:bg-secondary focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary">{{ $t('Create template') }}</Link>
                </div>
            </div>
