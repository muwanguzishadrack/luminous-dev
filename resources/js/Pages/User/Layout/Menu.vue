<template>
    ...
    <div class="flex-grow space-y-3 px-2 overflow-y-scroll">
        <div class="flex-1">
            <ul class="pt-2 space-y-1 text-sm mb-2">
                <li class="hover:bg-slate-50 hover:text-black rounded-[5px] px-2 truncate" :class="$page.url.startsWith('/dashboard') ? 'bg-primary text-white' : ''">
                ...
                <li class="hover:bg-slate-50 hover:text-black rounded-[5px] px-2 truncate" :class="$page.url.startsWith('/chats') ? 'bg-primary text-white' : ''">
                    <Link rel="noopener noreferrer" href="/chats" class="flex items-center justify-between p-2 space-x-3 rounded-md">
                        ...
                        <span v-if="parseInt(unreadMessages) > 0" class="bg-highlight text-secondary px-2 text-[11px] rounded-md">{{ unreadMessages }}</span>
                    </Link>
                </li>
                <li class="hover:bg-slate-50 hover:text-black rounded-[5px] px-2 truncate" :class="$page.url.startsWith('/contact') ? 'bg-primary text-white' : ''">
                ...
                <li class="hover:bg-slate-50 hover:text-black rounded-[5px] px-2 truncate" :class="$page.url.startsWith('/campaign') ? 'bg-primary text-white' : ''">
                ...
                <li class="hover:bg-slate-50 hover:text-black rounded-[5px] px-2 truncate" :class="$page.url.startsWith('/template') ? 'bg-primary text-white' : ''">
                ...
                <li class="hover:bg-slate-50 hover:text-black rounded-[5px] px-2 truncate" :class="$page.url.startsWith('/automation') ? 'bg-primary text-white' : ''">
            ...
            <ul class="pb-4 space-y-1 text-sm mt-2">
                <li class="hover:bg-slate-50 hover:text-black rounded-[5px] px-2 truncate" :class="$page.url.startsWith('/team') ? 'bg-primary text-white' : ''">
                ...
                <li class="hover:bg-slate-50 hover:text-black rounded-[5px] px-2 truncate" :class="$page.url.startsWith('/settings') ? 'bg-primary text-white' : ''">
                ...
                <li class="hover:bg-slate-50 hover:text-black rounded-[5px] px-2 truncate" :class="$page.url.startsWith('/billing') || $page.url.startsWith('/subscription') ? 'bg-primary text-white' : ''">
                ...
                <li class="hover:bg-slate-50 hover:text-black rounded-[5px] px-2 truncate" :class="$page.url.startsWith('/support') ? 'bg-primary text-white' : ''">
                ...
                <li v-if="user.teams[0]['role'] === 'owner'" class="hover:bg-slate-50 hover:text-black rounded-[5px] px-2 truncate" :class="$page.url.startsWith('/developer-tools') ? 'bg-primary text-white' : ''">
    ...
    <div v-if="menuIconsOnly === false" @click="switchTeams()" class="border-2 border-slate-300 text-sm rounded-[5px] mb-1 m-3 py-2 px-4 flex items-center justify-between cursor-pointer">
    ...
    <div class="flex items-center m-3 p-2 rounded-xl h-14 py-1 md:py-1 mt-2 gap-x-4 bg-slate-50" :class="!menuIconsOnly ? 'justify-between' : 'justify-center'">
        <div v-if="!menuIconsOnly" class="flex space-x-2">
            <div class="rounded-xl p-1 text-gray-700 bg-slate-200">
            ...
            <div>
                <h2 class="text-[15px] capitalize truncate w-[6em]"  :class="menuIconsOnly ? 'hidden' : ''">{{ user.first_name }}</h2>
        ...
        <Link href="/logout" class="hover:bg-slate-200 text-gray-700 hover:rounded-full w-[fit-content] p-2">
