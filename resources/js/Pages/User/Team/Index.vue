    ...
    <AppLayout>
        <div class="bg-white md:bg-inherit pt-10 px-4 md:pt-8 md:p-8 rounded-[5px] text-[#000] h-full md:overflow-y-auto">
            <div class="flex justify-between">
                ...
                <div>
                    <button @click="openModal()" class="rounded-md bg-primary px-3 py-2 text-sm text-white hover:bg-secondary focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary">{{ $t('Invite user') }}</button>
                </div>
            </div>
            <!-- Table Component-->
