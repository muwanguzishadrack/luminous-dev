    ...
    <AppLayout>
        <div class="p-4 md:p-8 rounded-[5px] h-full overflow-y-auto capitalize">
            <div class="flex justify-between">
                ...
                <div class="space-x-2">
                    <a :href="'/campaigns/export/' + props.campaign.uuid" class="rounded-md bg-primary hover:bg-secondary px-3 py-2 text-sm text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary">
                        {{ $t('Export as CSV') }}
                    </a>

                    <Link href="/campaigns" class="rounded-md bg-slate-200 hover:bg-slate-300 px-3 py-2 text-sm text-gray-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary">
                        {{ $t('Back') }}
                    </Link>
                </div>
            </div>
