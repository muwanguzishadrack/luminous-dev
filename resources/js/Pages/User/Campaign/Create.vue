        ...
        <div class="md:flex md:flex-col bg-white border-l py-4 text-[#000] capitalize overflow-y-hidden">
            <div class="flex justify-between px-8 border-b pb-2">
                ...
                <div class="space-x-2 flex items-center">
                    <Link href="/campaigns" class="rounded-md bg-slate-200 px-3 py-2 text-sm text-gray-700 hover:bg-slate-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary">{{ $t('Back') }}</Link>
                </div>
            </div>
