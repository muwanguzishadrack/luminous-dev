<template>
    <AppLayout>
        <div class="flex justify-between">
            ...
            <div>
                <button @click="openModal()" type="button" class="rounded-md bg-primary px-3 py-2 text-sm text-white shadow-sm hover:bg-secondary focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary">{{ $t('Add page') }}</button>
            </div>
        </div>
