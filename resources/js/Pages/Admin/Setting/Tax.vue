<template>
    <AppLayout>
        <div class="flex justify-between">
            ...
            <div>
                <button @click="openModal()" type="button" class="rounded-md bg-primary px-3 py-2 text-sm text-white shadow-sm hover:bg-secondary focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary">{{ $t('Add tax rate') }}</button>
            </div>
        </div>
        ...
        <div class="bg-white rounded-md mb-4 py-4 px-4 flex grid grid-cols-2">
            ...
            <div>
                ...
                <button @click="submitForm1()" type="button" class="rounded-md bg-primary mt-4 px-3 py-2 text-sm text-white shadow-sm hover:bg-secondary focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary">{{ $t('Update') }}</button>
            </div>
        </div>
