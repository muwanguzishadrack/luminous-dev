    ...
    <AppLayout>
        <div class="flex justify-between">
            ...
            <div class="flex items-center space-x-2">
                <button @click="isOpenModal = true" class="rounded-md bg-primary px-3 py-2 text-sm text-white hover:bg-secondary focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary">{{ $t('Bulk edit translations') }}</button>
                <Link href="/admin/languages" class="rounded-md bg-slate-200 px-3 py-2 text-sm text-gray-700 hover:bg-slate-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary">{{ $t('Back') }}</Link>
            </div>
        </div>
