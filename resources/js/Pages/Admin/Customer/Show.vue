    ...
    <AppLayout>
        <div class="bg-white md:bg-inherit pt-0 px-4 md:pt-8 md:p-8 rounded-[5px] text-[#000] h-full md:overflow-y-scroll">
            <div v-if="props.user === null" class="md:flex justify-between hidden">
                ...
                <div>
                    <Link href="/admin/users" class="rounded-md bg-slate-200 px-3 py-2 text-sm text-gray-700 hover:bg-slate-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary">{{ $t('Back') }}</Link>
                </div>
            </div>
            ...
            <form v-if="tab === 'user'" @submit.prevent="submitForm()" class="bg-white py-5 px-5 rounded-bl-[0.5rem] rounded-br-[0.5rem]">
                ...
                <div class="py-6">
                    <button type="submit" :disabled="form.processing" class="float-right flex items-center space-x-4 rounded-md bg-primary px-3 py-2 text-sm text-white shadow-sm hover:bg-secondary focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary">
                        {{ $t('Save') }}
                    </button>
                </div>
            </form>
