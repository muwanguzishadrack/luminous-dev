    ...
    <AppLayout>
        <div class="p-8 rounded-[5px] text-[#000] overflow-y-scroll">
            <div class="flex justify-between">
                ...
                <div>
                    <Link href="/admin/faqs" class="rounded-md bg-slate-200 px-3 py-2 text-sm text-gray-700 shadow-sm hover:bg-slate-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary">{{ $t('Back') }}</Link>
                </div>
            </div>
