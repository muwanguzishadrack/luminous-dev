    ...
    <AppLayout>
        <div class="bg-white md:bg-inherit p-4 md:p-8 rounded-[5px] text-[#000] h-full overflow-y-auto">
            ...
            <div class="md:flex space-x-2 md:space-x-2 mt-4 md:mt-0 mb-8 text-xl md:text-sm hidden">
                <Link href="/admin/organizations/create" class="bg-primary hover:bg-secondary py-2 px-3 rounded-lg text-white text-center">{{ $t('Add organization') }}</Link>
                <Link href="/admin/users/create" class="bg-primary hover:bg-secondary py-2 px-3 rounded-lg text-white text-center">{{ $t('Add user') }}</Link>
            </div>
