        ...
        <div class="flex justify-center">
            <div class="w-[20em] mt-40">
                ...
                <div class="text-center text-sm text-slate-500">
                    ...
                    <Link href="signup" class="text-sm text-primary-600 text-primary border-b hover:border-primary">{{ $t('Create one here') }}</Link>
                </div>
                <form @submit.prevent="submitForm()" class="mt-5">
                    ...
                    <div class="flex items-center justify-between mt-5">
                        ...
                        <Link href="/forgot-password" class="text-sm text-primary dark:text-primary-500 border-b hover:border-primary">{{ $t('Forgot password?') }}</Link>
                    </div>
                    <div class="mt-6">
