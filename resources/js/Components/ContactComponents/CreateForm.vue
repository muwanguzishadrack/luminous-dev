...
<template>
    <div class="h-20 bg-white border-b border-1 md:flex items-center justify-between px-10 hidden">
        ...
        <div>
            <Link v-if="!props.contact" href="/contacts" class="inline-flex justify-center rounded-md border border-transparent bg-slate-200 px-4 py-2 text-sm text-slate-700 hover:bg-slate-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 mr-4">{{ $t('Cancel') }}</Link>
            <Link v-else :href="'/contacts/' + props.contact.uuid" class="inline-flex justify-center rounded-md border border-transparent bg-slate-200 px-4 py-2 text-sm text-slate-700 hover:bg-slate-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 mr-4">{{ $t('Back') }}</Link>
        </div>
    </div>
    <div class="flex justify-center md:h-[90vh] md:overflow-y-scroll">
        <form @submit.prevent="submitForm()" class="w-[30em]">
            <div class="flex justify-center items-center">
                ...
                <label for="file-upload" class="cursor-pointer inline-flex justify-center rounded-md border border-transparent bg-slate-200 px-4 py-2 text-sm text-slate-700 hover:bg-slate-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 mr-4">{{ $t('Upload image') }}</label>
            </div>
            ...
            <div class="mt-4 mb-10 pb-10 flex">
                <Link href="/contacts" class="inline-flex justify-center rounded-md border border-transparent bg-slate-200 px-4 py-2 text-sm text-slate-700 hover:bg-slate-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 mr-4">{{ $t('Cancel') }}</Link>
                <button :class="'inline-flex justify-center rounded-md border border-transparent bg-primary hover:bg-secondary px-4 py-2 text-sm text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2'">
                    <span>{{ $t('Save') }}</span>
                </button>
            </div>
        </form>
