        ...
        <div class="flex justify-center space-x-8 items-center pb-6 pr-20 border-gray-300 border-b">
            ...
            <div>
                ...
                <div class="flex space-x-3 mt-4">
                    <button class="bg-primary hover:bg-secondary text-white h-9 px-4 rounded-md flex items-center">
                        <Link :href="'/contacts/' + contact.uuid + '?edit=true'" class="text-[14px]">{{ $t('Edit') }}</Link>
                    </button>
                    <button class="bg-slate-200 hover:bg-slate-300 h-9 px-4 rounded-md flex items-center">
                    ...
                    <button @click="favorite()" class="bg-slate-200 hover:bg-slate-300 h-9 px-4 rounded-md">
                    ...
                    <Dropdown class="h-100" :align="'right'">
                        <button class="h-9 bg-slate-200 hover:bg-slate-300 py-2 px-3 rounded-md flex items-center">
                            <span class="">
