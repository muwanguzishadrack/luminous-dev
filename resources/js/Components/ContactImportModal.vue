...
<template>
    ...
    <Modal :label="modalLabel" :isOpen="isOpenModal">
        ...
        <div class="text-sm text-primary underline flex mt-4 mb-6">
                    ...
                    <div class="text-center">
                        <div>
                            ...
                            <div class="flex text-sm text-gray-600">
                                <label for="file-upload" class="relative cursor-pointer bg-white rounded-md font-medium text-primary hover:text-secondary focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
